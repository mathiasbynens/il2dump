...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("Metadata loaded in {:.2?}", start.elapsed());
    ...
    println!("Executable parsed in {:.2?}", start.elapsed());
    println!(
    ...
    println!("Registration search completed in {:.2?}", start.elapsed());
    ...
    println!("Executor initialized in {:.2?}", start.elapsed());
    ...
    println!("Decompiled in {:.2?}", start.elapsed());

    println!(
        "Dump completed successfully in {:.2?}",
        total_start.elapsed()
    );
    Ok(())
}
